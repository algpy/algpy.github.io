...
const patchTripDay = (day) => {
  ...
  if (day.id === "sep14") {
    ...
    let sources = (corrected.sources || []).filter(
      (source) => !`${source.label || ""} ${source.source || ""}`.includes("Voss Gondol"),
    );
    sources = addSourceOnce(sources, {
      label: "Store Ringheim transport",
      type: "住宿官网",
    ...
    return {
      ...
      verified:
        "Store Ringheim地址与预约免费送站方式、Voss Stop A、目标09:50巴士和12:10–14:10 Nærøyfjord船已核对；酒店送站、巴士到达分钟、码头与开船仍只认书面确认和实际票面。",
      route:
        "Store Ringheim → 免费预约送站/出租车 → Voss Stop A 09:50 → Gudvangen Stop H → 12:10 Nærøyfjord船 → Flåm 14:10",
      main: corrected.main?.some((item) => item.title?.includes(storeRingheimName))
        ? corrected.main
        : [
      ...
      sights: [
        {
          ...
          photoTip: "先拍峡湾纵深，再拍陡壁、瀑布和村落尺度；不倚越栏杆。",
          ...
          imageLabel: "Nærøyfjord观光船峡湾实景",
          fallbackImage:
            "/nordic-dubai-field-guide/images/localized/Bolstadfjorden-norge-d2129bbc6f.jpg",
          fallbackImageSource:
            "https://commons.wikimedia.org/wiki/Category:N%C3%A6r%C3%B8yfjord",
          fallbackImageLabel: "西挪威峡湾备用实景",
        },
        {
          kind: "attraction",
          ...
          effort: "低",
          gear: "普通舒适鞋；大件先放住宿",
          photoTip: "先拍车辆或工程全景，再拍说明牌；遵守馆内拍摄规则。",
          ...
          imageLabel: "Flåm Railway Museum实景",
          fallbackImage:
            "/nordic-dubai-field-guide/images/localized/63aa2f95-1d89-4ea2-b0ff-c876c495a4c7-beautifulstations_flam-90767e266b.jpg",
          fallbackImageSource: "https://commons.wikimedia.org/wiki/Category:Fl%C3%A5m_station",
          fallbackImageLabel: "Flåm车站备用实景",
        },
      ],
      foods: [
        {
          ...
          map: "https://www.google.com/maps/search/?api=1&query=Gudvangen%20Ferry%20Terminal%20food",
          image:
            "/nordic-dubai-field-guide/images/localized/Norwegian.open.sandwich-01-07678aecaf.jpg",
          imageSource:
            "https://commons.wikimedia.org/wiki/File:Norwegian.open.sandwich-01.jpg",
          imageLabel: "挪威开放式三明治路餐实景参考",
          fallbackImage:
            "/nordic-dubai-field-guide/images/localized/Fish-soup-in-Bergen-8d55dba7b8.jpg",
          fallbackImageSource:
            "https://commons.wikimedia.org/wiki/File:Fish_soup_in_Bergen.jpg",
          fallbackImageLabel: "挪威热汤备用实景参考",
        },
        {
          name: "Flåm Bakery",
          type: "烘焙与轻食 · 到达后补给",
          ...
          map: "https://www.google.com/maps/search/?api=1&query=Fl%C3%A5m%20Bakery",
          image:
          ...
          imageLabel: "Flåm Bakery官方烘焙实景",
          fallbackImage:
            "/nordic-dubai-field-guide/images/localized/Flam-Bakery-official-service.jpg",
          fallbackImageSource: "https://www.norwaysbest.com/en/food-and-drink/flam-bakery",
          fallbackImageLabel: "Flåm Bakery服务台备用实景",
        },
      ],
      social: [
